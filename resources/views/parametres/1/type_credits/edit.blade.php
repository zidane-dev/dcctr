...
@section('title')
    @lang('type_credits.edit type_credit')
@stop
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('typecredits.update',$type_credit->id)}}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputName" name="type_credit_fr" dir="ltr"
                                   title="@lang('type_credits.form.title')" value="{{$type_credit->type_credit_fr}}">
                        </div>
