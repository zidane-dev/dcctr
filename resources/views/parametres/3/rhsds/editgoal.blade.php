...
@include('parametres.partials_1.breadcrumb', ['sidebar'=> 'sidebar.rhsds', 'page' => 'rhsd.edit goal'])
        ...
        <div class="col-lg-12 col-md-12 ">
            <div class="card">
                ...
                <div class= "card-header">
                    <h3 class="text-center">@lang('rhsd.edit goal')</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('update.rhsgoal',$rhsd->id) }}" method="post" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="domaine" class="form-control SlectBox" disabled>
                                        <option value="" >@lang('rhsd.choi_domaine')</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="qualite" class="form-control SlectBox" disabled>
                                        <option value=""  > @lang('rhsd.choi_qualite')</option>
