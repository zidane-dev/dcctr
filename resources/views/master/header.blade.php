    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href=""><img src="{{URL::asset('assets/img/mcinet/logo.png')}}" class="logo-1" alt="logo"></a>
                <a href=""><img src="{{URL::asset('assets/img/mcinet/logo.png')}}" class="dark-logo-1" alt="logo"></a>
                <a href=""><img src="{{URL::asset('assets/img/mcinet/logo.png')}}" class="logo-2" alt="logo"></a>
                <a href=""><img src="{{URL::asset('assets/img/mcinet/logo.png')}}" class="dark-logo-2" alt="logo"></a>
            </div>
            <div class="app-sidebar__toggle" data-toggle="sidebar">
                @if(LaravelLocalization::getCurrentLocale() === "fr")
                    <a class="open-toggle" href="#"><i class="header-icon fe fe-arrow-left" ></i></a>
                @elseif(LaravelLocalization::getCurrentLocale() === "ar")
                    <a class="open-toggle" href="#"><i class="header-icon fe fe-arrow-right" ></i></a>
                @endif
                    <a class="close-toggle" href="#"><i class="header-icons fe fe-menu"></i></a>
            </div>
