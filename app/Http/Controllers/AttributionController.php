...
class AttributionController extends Controller
{
    ...
    public function __construct(){
        $this->middleware(['permission:access-attributions']);
        $this->middleware(['permission:list-attributions'])->only('index');
        $this->middleware(['permission:create-attributions'])->only(['create', 'store']);
        $this->middleware(['permission:edit-attributions'])->only(['edit', 'update']);
        $this->middleware(['permission:delete-attributions'])->only('destroy');
    }
