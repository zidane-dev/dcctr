...
class SecteurController extends Controller
{
    ...
    {
        $this->middleware(['permission:access-secteurs']);
        $this->middleware(['permission:list-secteurs'])->only('index');
        $this->middleware(['permission:create-secteurs'])->only(['create', 'store']);
        $this->middleware(['permission:edit-secteurs'])->only(['edit', 'update']);
        $this->middleware(['permission:delete-secteurs'])->only('destroy');
    }
